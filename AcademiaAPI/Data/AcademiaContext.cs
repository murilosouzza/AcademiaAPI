...
public class AcademiaContext : DbContext
{
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		modelBuilder.Entity<Turma>().HasData(
			new Turma { IdTurma = 1, NomeTurma = "Musculação Manhã", Modalidade = "Musculação", DiaSemana = "Segunda", Horario = new TimeOnly(7, 0), CapacidadeMaxima = 30, IdInstrutor = 1 },
			new Turma { IdTurma = 2, NomeTurma = "Yoga Tarde", Modalidade = "Yoga", DiaSemana = "Quarta", Horario = new TimeOnly(14, 0), CapacidadeMaxima = 20, IdInstrutor = 2 }
		);
